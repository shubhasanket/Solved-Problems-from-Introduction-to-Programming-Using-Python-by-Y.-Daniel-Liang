'''23.3 (Implementing Dijkstra’s algorithm using adjacency matrix)
The text implements Dijkstra’s algorithm using priority queues on adjacent
edges. Implement the algorithm using adjacency matrix for weighted graphs.
'''
...
##    a = graph1.getMinimumSpanningTree_Kruskals()
    b = graph1.getShortestPath(graph1.getIndex('Houston'))
    c = graph1.getShortestPath_Adj(graph1.getIndex('Houston'))
