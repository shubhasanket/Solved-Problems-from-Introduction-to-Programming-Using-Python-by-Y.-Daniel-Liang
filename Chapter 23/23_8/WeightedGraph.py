'''23.8 (Traveling salesman problem) The traveling salesman problem (TSP)
is to find a shortest round-trip route that visits each city exactly once
and then returns to the starting city. The problem is equivalent to finding
a shortest Hamiltonian cycle. Add the following method in the WeightedGraph
class:
...
I have added a getAllHamiltonianCycles method to graphs (graph_kamal). The source is MyGraph
in 22_14
'''
