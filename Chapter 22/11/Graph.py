'''
22.9 (Get bipartite sets) Add a new method in Graph to return two bipartite
sets if the graph is bipartite:
def getBipartite():
The method returns a list that contains two sublists, each of which contains
a set of vertices. If the graph is not bipartite, the method returns None.
'''
