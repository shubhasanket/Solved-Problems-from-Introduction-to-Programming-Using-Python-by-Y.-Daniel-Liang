"""18.4 (Create a doubly-linked list) The LinkedList class used in
Listing 18.2 is a one-way directional linked list that enables one-way
traversal of the list. Modify the Node class to add the new field name
previous to refer to the previous node in the list
"""
...
class LinkedList:
    ...
    def addLast(self, e):
        ...
        if self.__tail == None:
            ...
            self.__tail = newNode # tail now points to the last node
...
def main():
    l1 = ["Tom", "George", "Jean", "Jane", "George"]
