"""19.1 (Adding new methods in BST) Add the following new methods in BST.
...
"""
import sys
sys.path.append(r'C:\Users\Shubham\AppData\Local\Programs\Python\Python39\Workspace\Chapter_19\mod')
print(sys.path)
